        ...
        {part.count === 0?
            <div className='part' onClick={(e:any)=>{
                ...
                {menu?<div className='part_display_none active'>
                    <button><Image src={deleteImg} width={55} height={55} alt='Удалить запчасть' title='Удалить запчасть'/></button>
                    <button><Image src={edit} width={55} height={55} alt='Редактировать запчасть' title='Редактировать запчасть'/></button>
                ...
                <div className='otherData'>
                    {visibleLinkWindow?<LinkWindow part={part} visible={visibleLinkWindow} setVisible={setVisibleLinkWindow}/>:<></>}
